...
export default function Explore() {
  ...
  const buildQuery = useCallback(() => {
    ...
    // Garantir que haja uma query padrão se nada for especificado
    return query.trim() || "stars:>10000";
  }, [filters, userProfile]);

  // Query para buscar repositórios recomendados
  const recommendedQuery = useQuery({
    queryKey: ["recommended", buildQuery(), currentPage],
  ...
  return (
    <PageLayout>
      <div className="py-6 space-y-8">
        ...
        <Filters onFilterChange={handleFilterChange} isLoading={recommendedQuery.isLoading} />
              ...
              {recommendedQuery.isLoading ? (
                ...
                <div className="text-center py-12 border rounded-lg bg-muted/20">
                  ...
                  <p className="text-muted-foreground mt-2">
                    Ocorreu um erro ao buscar repositórios. Tente novamente mais tarde.
                  </p>
                </div>
          ...
          {activeTab === "recommended" &&
            ...
            recommendedQuery.data.repositories.length > 0 && (
              <Pagination
                ...
                totalPages={Math.ceil(Math.min(recommendedQuery.data.totalCount || 0, 1000) / perPage)}
